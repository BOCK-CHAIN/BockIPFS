      ...
      <div className="mb-6 space-y-4">
        <div className="flex items-center gap-2">
          <input
            ...
            disabled={addingFolder || uploadingFile}
            onKeyPress={(e) => {
              if (e.key === 'Enter' && !addingFolder && !uploadingFile) {
                handleAddFolder();
              }
            }}
          />
          <button 
            ...
            disabled={addingFolder || uploadingFile || !folderName.trim()}
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            disabled={addingFolder || uploadingFile || !selectedFile}
          >
